...
public class DictionaryScreen extends BorderPane {
    ...
    private void performSearch(String query) {
        ...
        if (definition != null) {
            ...
            starIcon.setOnMouseClicked(e -> {
                saveToFavorites(query);
                starIcon.setImage(new Image("file:static files/img/fav_filled.png"));
            });
    ...
    private void saveToFavorites(String word) {
    ...
    private void updateFavoritesList() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                favoriteWords.getItems().add(word + " (Added: " + date + ")\n" + context);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
